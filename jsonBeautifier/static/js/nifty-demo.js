...
$(document).on('nifty.ready', function () {
    ...
    // SETTINGS WINDOW
    // =================================================================
    var contentIndi = '<div id="settings-load" class="settings-load"><i class="text-main pli-repeat-2 icon-3x fa-spin"></i><br><h4 id="get-status" class="text-bold text-uppercase">Loading...</h4><p id="get-status-text">Please wait while the content is loaded</p></div>';
    var settingsComp = '<div id="nifty-settings" class="nifty-settings"><button id="set-btn" class="btn"><i class="psi-gear"></i></button><div id="set-content" class="set-content"></div></div>';

    $("body").append(settingsComp);

    $('#set-btn').one('click', function(){
        $("#nifty-settings").addClass("in");
        $("#set-content").append(contentIndi);
        $.get("settings.html", function( data ) {
            $("#set-content").empty().append(data);
            settingsInit();
        }).fail(function(e) {
            $("#get-status").html(e.status);
            $("#get-status-text").html(e.statusText);
        });
    });
    ...
    var settingsInit = function(){
        ...
        // BOXED LAYOUT
        // =================================================================
        var boxedLayoutCheckbox     = document.getElementById('box-lay'),
            boxedLayoutImgBtn       = document.getElementById('box-img'),
            boxedLayoutImgBox       = $('#bg-boxed'),
            boxedLayoutBtnClose     = document.getElementById('close-boxed-img'),
            blurredBgList           = $('#blurred-bg'),
            polygonBgList           = $('#polygon-bg'),
            abstractBgList          = $('#abstract-bg');
        ...
        var effectList = 'easeInQuart easeOutQuart easeInBack easeOutBack easeInOutBack steps jumping rubber',
            animCheckbox = document.getElementById('anim'),
            transitionVal = document.getElementById('ease');
        ...
        // =================================================================
        // =================================================================
        var navbarFixedCheckbox = document.getElementById('navbar-fixed');
        ...
        // =================================================================
        // =================================================================
        var footerFixedCheckbox = document.getElementById('footer-fixed');
        ...
        // =================================================================
        // =================================================================
        var collapsedCheckbox   = document.getElementById('nav-coll'),
            navFixedCheckbox    = document.getElementById('nav-fixed'),
            navProfileCheckbox  = document.getElementById('nav-profile'),
            navShortcutCheckbox = document.getElementById('nav-shortcut'),
            navOffcanvasSB      = document.getElementById('nav-offcanvas'),
        ...
        // =================================================================
        // =================================================================
        var asdVisCheckbox      = document.getElementById('asd-vis'),
            asdFixedCheckbox    = document.getElementById('asd-fixed'),
            asdFloatCheckbox    = document.getElementById('asd-float'),
            asdPosCheckbox      = document.getElementById('asd-align'),
            asdThemeCheckbox    = document.getElementById('asd-themes');
        ...
        $('#theme').on('click', '.theme', function (e) {
            e.preventDefault();
            var el = $(this);
